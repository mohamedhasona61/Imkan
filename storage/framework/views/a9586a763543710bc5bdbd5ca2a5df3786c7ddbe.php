...
<div id="invoice-print-zone">
    ...
    <?php else: ?>
    <div class="email_new_booking">
        <?php echo $__env->make($service->email_new_booking_file_app ?? '', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <?php endif; ?>
    <?php endif; ?>
</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('Layout::empty', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/nileview.dokkan.design/v1/themes/Base/User/Views/frontend/bookingInvoice.blade.php ENDPATH**/ ?>