                            ...
                            <?php if($rows->total() > 0): ?>
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="<?php echo e($row->status); ?>">
                                        ...
                                        <?php 
                                        $category =\Modules\Tour\Models\TourCategory::find($row->category_id);
                                        ?>
                                        <td class="title">
                                            <a href="<?php echo e(route('tour.admin.edit',['id'=>$row->id])); ?>"><?php echo e($row->title); ?> - <?php echo e($category->name ?? ''); ?> - <?php echo e($row->location->name ?? ''); ?></a>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/nileview.dokkan.design/v1/modules/Tour/Views/admin/index.blade.php ENDPATH**/ ?>