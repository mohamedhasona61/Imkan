<div class="bravo_filter">
    <form action="<?php echo e(url(app_get_locale(false,false,'/').config('tour.tour_route_prefix'))); ?>" class="bravo_form_filter">
        ...
        <div class="g-filter-item d-none">
        ...
        <div class="g-filter-item">
            ...
            <div class="item-content">
                <ul>
                    ...
                    $data_type = gettype($current_category_ids);
                    $current_category_ids = explode(",", $current_category_ids);
...
<?php /**PATH C:\mamp\htdocs\flouka\Imkan\Imkan8-6\v1\themes/BC/Tour/Views/frontend/layouts/search/filter-search.blade.php ENDPATH**/ ?>