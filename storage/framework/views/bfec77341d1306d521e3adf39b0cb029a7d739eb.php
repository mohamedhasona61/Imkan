...
<div class="sidebar-user">
    ...
    <div class="sidebar-menu">
        <ul class="main-menu">
            ...
            <li><a href="<?php echo e(route('vendor.timeslots')); ?>"><i class="icon ion-md-analytics"></i> <?php echo e(__('Time Slots')); ?></a></li>
            <?php endif; ?>
...
<?php /**PATH /www/wwwroot/nileview.dokkan.design/v1/themes/Base/User/Views/frontend/layouts/sidebar.blade.php ENDPATH**/ ?>