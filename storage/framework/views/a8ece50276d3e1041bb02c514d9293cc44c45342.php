    ...
    <div class="booking-review-content">
        ...
        <div class="review-section total-review">
            <ul class="review-list">
                ...
                <?php $__currentLoopData = $person_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li>
                    <div class="label"><?php echo e($type['name_'.$lang_local] ?? __($type['name'])); ?>: <?php echo e($type['number']); ?> * <?php echo e(format_money($type['display_price'])); ?></div>
                    <div class="val">
...
</div><?php /**PATH C:\mamp\htdocs\flouka\Imkan\Imkan8-6\v1\themes/Base/Tour/Views/frontend/booking/detail.blade.php ENDPATH**/ ?>