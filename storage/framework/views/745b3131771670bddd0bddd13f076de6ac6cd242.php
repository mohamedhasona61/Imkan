    ...
    <div class="form-content">
        ...
        <?php if($location_search_style == 'autocompletePlace'): ?>
            <div class="g-map-place">
                <input type="text" name="map_place" placeholder="<?php echo e(__('Choose Your Tour?')); ?>"
                    value="<?php echo e(request()->input('cat_id')); ?>" class="form-control border-0">
            </div>
        <?php else: ?>
            <?php
                $category_name = '';
            ...
            <div class="smart-search">
                <input type="text" class="smart-search-location parent_text form-control"
                    <?php echo e(empty(setting_item('tour_location_search_style')) || setting_item('tour_location_search_style') == 'normal' ? 'readonly' : ''); ?>

                    placeholder="<?php echo e(__('Choose Your Tour Type?')); ?>" value="<?php echo e($category_name); ?>"
...
<?php /**PATH /www/wwwroot/nileview.dokkan.design/v1/themes/BC/Tour/Views/frontend/layouts/search/fields/category.blade.php ENDPATH**/ ?>