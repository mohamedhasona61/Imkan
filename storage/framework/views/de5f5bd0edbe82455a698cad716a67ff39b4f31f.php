                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                $choosed_extra_price_array = json_decode($choosed_extra_price_array, true);
                                ?>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <label class="control-label"><?php echo e($price['name']); ?> (<?php echo e($price['name']); ?>) </label>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex justify-content-around align-items center">
                                                <button data-mainMenu-id="<?php echo e($main_menu['id']); ?>" data-insideMenu-id="<?php echo e($inside_menus['id']); ?>" data-term-id="<?php echo e($term['id']); ?>" id="<?php echo e('increase-' . $main_menu['id'] . '-' . $inside_menus['id'] . '-' . $term['id']); ?>" class=" btn btn-sm increase" style="background-color: unset ; border:  0.5px solid #263a53">
                                                    ...
                                                    <?php if(is_string($choosed_menus_array)): ?>
                                                        <?php $choosed_menus_array = json_decode($choosed_menus_array, true); ?>
                                                    <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/nileview.dokkan.design/v1/themes/Base/User/Views/frontend/EditBookingForApp.blade.php ENDPATH**/ ?>