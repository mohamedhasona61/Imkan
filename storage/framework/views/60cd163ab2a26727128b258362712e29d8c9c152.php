<div class="modal fade" id="modal-paid-<?php echo e($booking->id); ?>">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <?php 
            $remain=$booking->total - $booking->paid ;
            ?> 
            <!-- Modal footer -->
...
<?php /**PATH /www/wwwroot/nileview.dokkan.design/v1/themes/Base/Tour/Views/frontend/booking/set-paid-modal.blade.php ENDPATH**/ ?>