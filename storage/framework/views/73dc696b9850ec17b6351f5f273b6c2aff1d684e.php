    ...
    <div class="booking-review-content">
            ...
            <div class="service-info">
                ...
                <?php if($vendor->hasPermission('dashboard_vendor_access') and !$vendor->hasPermission('dashboard_access')): ?>
                    <div class="mt-1">
                        ...
                        <?php echo e(__('Vendor')); ?>: <a href="<?php echo e(route('user.profile', ['id' => $vendor->id])); ?>"
                            target="_blank"><?php echo e($vendor->getDisplayName()); ?></a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
        <div class="review-section">
            <ul class="review-list">
                <?php if($booking->start_date): ?>
                    ...
                    <?php
                    $tour_price = \Modules\Tour\Models\Tour::where('id', $booking->object_id)->first(); ?>
                    <?php if($tour_price->price > 0): ?>
                        <li>
                            <div class="label"> <?php echo e(__('Main Price')); ?>:</div>
                            <div class="val">
                                <?php echo e($tour_price->price); ?>
        ...
        <div class="review-section total-review">
            <ul class="review-list">
                ...
                <?php if(!empty($person_types)): ?>
                    <?php $__currentLoopData = $person_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            ...
                            <div class="label">
                                <?php if(isset($type['name_' . $lang_local])): ?>
                                    <?php echo e($type['name_' . $lang_local]); ?>
                                ...
                                <?php endif; ?>
                                : <?php echo e($type['number']); ?> *
                                <?php if(isset($type['display_price'])): ?>
                                    <?php echo e(format_money($type['display_price'])); ?>

                                <?php else: ?>
                                    <?php echo e(format_money($type['price'])); ?>
                            ...
                            <?php if(isset($type['display_price'])): ?>
                                <div class="val">
                                    <?php echo e(format_money($type['display_price'] * $type['number'])); ?>
                ...
                <?php else: ?>
                    <li>
                        <div class="label"><?php echo e(__('Guests')); ?>: <?php echo e($booking->total_guests); ?> *
                            <?php echo e(format_money($booking->getMeta('base_price'))); ?></div>
                        <div class="val">
                            ...
                            <li class="no-flex">
                                <ul>
                                    <?php $__currentLoopData = $extra_price; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <div class="label"><?php echo e($extra_price->name ?? ''); ?>::</div>
                                            <div class="val">
                                                <?php echo e($extra_price->price); ?>
                ...
                <?php if(!empty($selectedItems)): ?>
                    <li>
                        <div class="label-title"><strong><?php echo e(__('Menus:')); ?></strong></div>
                    </li>
                    <li class="no-flex">
                        <ul>
                            <?php $__currentLoopData = $selectedItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <?php if(app()->getLocale() == 'ar'): ?>
                                        <div class="label"><?php echo e($type->name); ?>:</div>
                                    <?php else: ?>
                                        <div class="label"><?php echo e($type->name_en); ?>:</div>
                                    <?php endif; ?>
                                    <div class="val">
                                        <?php if($type->price > 0): ?>
                                            <?php echo e($type->count); ?> * <?php echo e($type->price); ?>

                                        <?php else: ?>
                                            <?php echo e($type->count); ?> (<?php echo e(__('Included')); ?>)
                                        <?php endif; ?>
                                    </div>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /www/wwwroot/nileview.dokkan.design/v1/themes/Base/Tour/Views/frontend/booking/detail.blade.php ENDPATH**/ ?>