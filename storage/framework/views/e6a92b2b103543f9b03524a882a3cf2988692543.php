...
<div class="container-fluid search-section"
    style="background-image: url(<?php echo e(asset('dist/frontend/images/search.jpg')); ?>);background-position: center;background-attachment: fixed;background-size: cover;padding: 78px 0px;;display: flex;align-items: center;">
    <div class="container ">
        <div class="row"> 
            <div class="col-lg-5">
                        ...
                        <ul class="nav nav-tabs  m-0" role="tablist">
                            <?php if(!empty($service_types)): ?>
                                ...
                                <?php $__currentLoopData = $service_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <li role="bravo_<?php echo e($service_type); ?>" class="w-100">
                                        <a href="#bravo_<?php echo e($service_type); ?>"
                                            class="<?php if($number == 0): ?> active <?php endif; ?> d-flex justify-content-start"
                                            aria-controls="bravo_<?php echo e($service_type); ?>" role="tab" data-toggle="tab">
                        ...
                        <div class="tab-content">
                            <?php if(!empty($service_types)): ?>
                                ...
                                <?php $__currentLoopData = $service_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <div role="tabpanel"
                                        class="tab-pane <?php if($number == 0): ?> active <?php endif; ?>"
                                        id="bravo_<?php echo e($service_type); ?>">
...
<?php /**PATH /www/wwwroot/nileview.dokkan.design/v1/themes/Base/Template/Views/frontend/blocks/form-search-all-service/style-normal.blade.php ENDPATH**/ ?>