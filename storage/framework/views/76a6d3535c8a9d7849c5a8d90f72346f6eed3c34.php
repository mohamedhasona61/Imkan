<div class="panel">
    ...
    <div class="panel-body">
        ...
        <?php if(is_default_lang()): ?>
            ...
            <div class="form-group-item" data-condition="enable_person_types:is(1)">
                ...
                <div class="g-items-header">
                    <div class="row">
                        <div class="col-md-3"><?php echo e(__("Person Type")); ?></div>
        ...
        <?php if(is_default_lang()): ?>
                <hr>
                <h3 class="panel-body-title" style="display:none"><?php echo e(__('Discount by number of people')); ?></h3>
        ...
        <?php if(is_default_lang() and (!empty(setting_item("tour_allow_vendor_can_add_service_fee")) or is_admin())): ?>
            ...
            <div class="form-group-item" data-condition="enable_service_fee:is(1)">
                ...
                <div class="g-items-header">
                    <div class="row">
                        <div class="col-md-6"><?php echo e(__("Name")); ?></div>
                        <div class="col-md-3"><?php echo e(__('Price')); ?></div>
...
<?php /**PATH /www/wwwroot/nileview.dokkan.design/v1/modules/Tour/Views/admin/tour/pricing.blade.php ENDPATH**/ ?>