...
<div class="form-group">
    ...
    <div class="">
        <select name="menu_id[]" class="form-control" multiple>
            ...
            $selectedMenus = array_map('intval', explode(',', $row->menu_id));
            ?>

            <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                $selected = in_array($menu->id, $selectedMenus) ? 'selected' : '';
                ?>
...
<?php /**PATH C:\mamp\htdocs\flouka\Imkan\Imkan8-6\v1\modules/Tour/Views/admin/tour/tour-content.blade.php ENDPATH**/ ?>