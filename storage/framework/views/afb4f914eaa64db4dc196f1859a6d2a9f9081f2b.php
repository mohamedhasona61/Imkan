            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        <?php echo e(date('Y')); ?> &copy; <?php echo e(__('Immkan by')); ?> <a href="<?php echo e(__('https://dokkan.agency')); ?>" target="_blank"><?php echo e(__('Dokkan Agency')); ?></a>
                    </div>
                    <div class="col-md-6">
...
<?php /**PATH C:\mamp\htdocs\flouka\Imkan\Imkan8-6\v1\modules/Layout/admin/app.blade.php ENDPATH**/ ?>