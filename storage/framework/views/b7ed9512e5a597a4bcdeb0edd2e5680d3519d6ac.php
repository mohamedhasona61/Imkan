...
<div class="header-logo flex-shrink-0">
    <h3 class="logo-text"><a href="<?php echo e(route('admin.index')); ?>"><?php echo e(__('Imkan Tours')); ?></a></h3>
</div>
...
<?php /**PATH /www/wwwroot/nileview.dokkan.design/v1/modules/Layout/admin/parts/header.blade.php ENDPATH**/ ?>