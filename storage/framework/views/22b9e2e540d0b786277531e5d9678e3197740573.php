<form action="<?php echo e(route("tour.search")); ?>" class="form bravo_form" method="get">
    ...
    <div class="g-button-submit">
        <button class="btn btn-primary btn-search btn-tour-search-design"  style="width: 91% !important; border-radius: 5px" type="submit"><?php echo e(__("Search")); ?></button>
    </div>
</form><?php /**PATH C:\mamp\htdocs\Imkan\v1\themes/BC/Tour/Views/frontend/layouts/search/form-search.blade.php ENDPATH**/ ?>