        ...
        <div class="form-group">
            ...
            <div class="">
                <select name="menu_id[]" class="form-control" multiple>
                    ...
                    $selectedMenus = explode(',', $row->menu_id);


                    $selectedMenus = ["48",49,50];
...
</div><?php /**PATH C:\mamp\htdocs\Imkan\v1\modules/Tour/Views/admin/tour/tour-content.blade.php ENDPATH**/ ?>