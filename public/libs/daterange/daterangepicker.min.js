...
(function (root, factory) {
    ...
    DateRangePicker.prototype = {
        ...
        updateCalendars: function () {
            ...
            this.renderCalendar('left',slug);
            this.renderCalendar('right',slug);
        ...
        renderCalendar: function (side,tourId) {
            var vm = this;
            
            $.ajax({
                url: '/get-disabled-dates/'+ tourId,
                dataType: 'json',
                type: 'get',
                ...
                error: function (e) {
                    console.log(e);
                    console.log("Unable to retrieve disabled dates");
                }
            });
            ...
            for (var row = 0; row < 6; row++) {
                ...
                for (var col = 0; col < 7; col++) {
                    ...
                    if (vm.disabledDates.includes(currentDate)) {
