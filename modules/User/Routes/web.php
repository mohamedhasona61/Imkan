...
Route::group(['prefix'=>'user','middleware' => ['auth','verified']],function(){
    ...
    Route::post('/filterbooking','UserController@filterbooking')->name("user.filter.booking_history");
    Route::get('/cancel_booking/{id}','UserController@cancel_booking')->name("user.cancel_booking");

    Route::get('/edit_booking/{id}','UserController@edit_booking')->name("vendor.edit_booking");
    Route::post('/update_booking','UserController@update_booking')->name("vendor.update_booking");
