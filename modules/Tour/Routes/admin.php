...
Route::group(['prefix'=>'menu'],function(){
    Route::get('/','MenuController@index')->name('tour.admin.menu.index');
    Route::get('/edit/{id}','MenuController@edit')->name('tour.admin.menu.edit');
    Route::post('/store/{id}','MenuController@store')->name('tour.admin.menu.store');
    Route::post('/editAttrBulk','MenuController@editAttrBulk')->name('tour.admin.menu.editAttrBulk');


    Route::get('/terms/{menu_id}','MenuController@terms')->name('tour.admin.menu.term.index');
    Route::get('/term_edit/{id}','MenuController@term_edit')->name('tour.admin.menu.term.edit');
    Route::post('/term_store/{id}','MenuController@term_store')->name('tour.admin.menu.term.store');
    Route::post('/editTermBulk','MenuController@editTermBulk')->name('tour.admin.menu.term.editTermBulk');
});
Route::group(['prefix'=>'menu_extras'],function(){
    Route::get('/','MenuController@index_extras')->name('tour.admin.extras.index');
    Route::get('/edit/{id}','MenuController@edit_extras')->name('tour.admin.extras.edit');
    Route::post('/store/{id}','MenuController@store_extras')->name('tour.admin.extras.store');
