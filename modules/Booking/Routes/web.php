...
Route::group(['prefix' => config('booking.booking_route_prefix')], function () {
    ...
    Route::get('/{code}', 'BookingController@detail')->name('booking.success');
...
Route::get('/MyFatooraCallback/{code}', 'BookingController@MyFatooraCallback')->name('MyFatooraCallback');
